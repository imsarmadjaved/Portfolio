...
const Experience = () => {
  ...
  return (
    ...
    >
      {/* Background decoration - enhanced for glass effect */}
              ...
              <div className="space-y-6">
                {experience.map((exp, index) => (
                  <AnimationWrapper
                    ...
                    delay={0.3 + index * 0.1}
                  >
                    <div className="group backdrop-blur-md bg-[var(--bg-secondary)]/70 rounded-2xl p-6 shadow-lg border border-[var(--neutral-200)]/10 hover:border-[var(--accent-primary)]/30 transition-all duration-500 hover:shadow-xl hover:-translate-y-1">
