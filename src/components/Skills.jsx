        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {currentSkills.map((skill, index) => (
              <div
                key={index}
                className="group backdrop-blur-md bg-[var(--bg-secondary)]/70 rounded-xl p-5 shadow-lg border border-[var(--neutral-200)]/10 hover:border-[var(--accent-primary)]/30 transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
              >
